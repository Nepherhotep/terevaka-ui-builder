...
#
# Created: Tue Mar 12 20:54:24 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_3 = QtGui.QFrame(self.properties)
        self.frame_3.setEnabled(True)
        self.frame_3.setGeometry(QtCore.QRect(10, 130, 181, 261))
        self.frame_3.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_3.setObjectName(_fromUtf8("frame_3"))
        self.groupBox_3 = QtGui.QGroupBox(self.frame_3)
        self.groupBox_3.setEnabled(True)
        self.groupBox_3.setGeometry(QtCore.QRect(10, 0, 161, 91))
        ...
        self.scalableLayoutRadio.setGeometry(QtCore.QRect(10, 60, 131, 20))
        self.scalableLayoutRadio.setObjectName(_fromUtf8("scalableLayoutRadio"))
        self.anchorYLabel = QtGui.QLabel(self.frame_3)
        self.anchorYLabel.setEnabled(False)
        self.anchorYLabel.setGeometry(QtCore.QRect(14, 150, 20, 21))
        self.anchorYLabel.setObjectName(_fromUtf8("anchorYLabel"))
        self.anchorYSpinBox = QtGui.QDoubleSpinBox(self.frame_3)
        self.anchorYSpinBox.setEnabled(False)
        self.anchorYSpinBox.setGeometry(QtCore.QRect(31, 148, 141, 25))
        self.anchorYSpinBox.setDecimals(2)
        self.anchorYSpinBox.setMaximum(99999.99)
        self.anchorYSpinBox.setProperty("value", 240.0)
        self.anchorYSpinBox.setObjectName(_fromUtf8("anchorYSpinBox"))
        self.anchorXSpinBox = QtGui.QDoubleSpinBox(self.frame_3)
        self.anchorXSpinBox.setEnabled(False)
        self.anchorXSpinBox.setGeometry(QtCore.QRect(31, 118, 141, 25))
        self.anchorXSpinBox.setDecimals(2)
        self.anchorXSpinBox.setMaximum(99999.0)
        self.anchorXSpinBox.setProperty("value", 320.0)
        self.anchorXSpinBox.setObjectName(_fromUtf8("anchorXSpinBox"))
        self.anchorXLabel = QtGui.QLabel(self.frame_3)
        self.anchorXLabel.setEnabled(False)
        self.anchorXLabel.setGeometry(QtCore.QRect(14, 120, 16, 21))
        self.anchorXLabel.setObjectName(_fromUtf8("anchorXLabel"))
        self.anchorLabel = QtGui.QLabel(self.frame_3)
        self.anchorLabel.setEnabled(False)
        self.anchorLabel.setGeometry(QtCore.QRect(70, 100, 51, 16))
        self.anchorLabel.setObjectName(_fromUtf8("anchorLabel"))
        self.layoutHeightSpinBox = QtGui.QDoubleSpinBox(self.frame_3)
        self.layoutHeightSpinBox.setEnabled(False)
        self.layoutHeightSpinBox.setGeometry(QtCore.QRect(30, 228, 141, 25))
        ...
        self.layoutWidthLabel = QtGui.QLabel(self.frame_3)
        self.layoutWidthLabel.setEnabled(False)
        self.layoutWidthLabel.setGeometry(QtCore.QRect(13, 200, 16, 21))
        self.layoutWidthLabel.setObjectName(_fromUtf8("layoutWidthLabel"))
        self.layoutHeightLabel = QtGui.QLabel(self.frame_3)
        self.layoutHeightLabel.setEnabled(False)
        self.layoutHeightLabel.setGeometry(QtCore.QRect(13, 230, 16, 21))
        self.layoutHeightLabel.setObjectName(_fromUtf8("layoutHeightLabel"))
        self.layoutWidthSpinBox = QtGui.QDoubleSpinBox(self.frame_3)
        self.layoutWidthSpinBox.setEnabled(False)
        self.layoutWidthSpinBox.setGeometry(QtCore.QRect(30, 198, 141, 25))
        ...
        self.layoutSizeLabel = QtGui.QLabel(self.frame_3)
        self.layoutSizeLabel.setEnabled(False)
        self.layoutSizeLabel.setGeometry(QtCore.QRect(80, 180, 31, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.anchorYLabel.setText(_translate("MainWindow", "Y", None))
        self.anchorXLabel.setText(_translate("MainWindow", "X", None))
        self.anchorLabel.setText(_translate("MainWindow", "Anchor", None))
        self.layoutWidthLabel.setText(_translate("MainWindow", "W", None))
        self.layoutHeightLabel.setText(_translate("MainWindow", "H", None))
        self.layoutSizeLabel.setText(_translate("MainWindow", "Size", None))
